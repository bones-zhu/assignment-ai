...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == 'rnn':
            dcaptions, dx, grads['Wx'], grads['Wh'], grads['b'] = rnn_backward(dx, caches.pop())
        else:
            dcaptions, dx, grads['Wx'], grads['Wh'], grads['b'] = lstm_backward(dx, caches.pop())
        grads['W_embed'] = word_embedding_backward(dcaptions, caches.pop())
        dx, grads['W_proj'], grads['b_proj'] = affine_backward(dx, caches.pop())
